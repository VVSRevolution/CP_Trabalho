...
Tabela.reset_index().plot(x='TIMES', y='index',label='Sequencial',xlabel="milisegundos", ylabel= "números de primos encontrados" )
Tabela2.reset_index().plot(x='TIMES', y='index',label='OMP',xlabel="milisegundos", ylabel= "números de primos encontrados")
